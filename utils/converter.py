...
def openimage2bb(annotations_path, images_dir, bb_type=BBType.GROUND_TRUTH):
    ...
    print("openimage2bb invalid ,no panda")
    # # Loop through each file
    # for file_path in annotation_files:
            ...
            for line in f:
                ...
                if(bb_type==BBType.GROUND_TRUTH):
                    ...
                    if int(class_id) == 1 :
                        ...
                        #cv2.putText(image, f'{confidence:.2f}', (x, y ), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 1)
                    elif int(class_id) == 2:
                        cv2.rectangle(image, (x, y), (x2, y2), (0,255,0), 1)
                        #cv2.putText(image, f'{confidence:.2f}', (x, y ), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255,0), 1)
                    save_path = os.path.join("/home/lynxi/Documents/model_accuracy_evaluate_tool_0620/vest_gt_pic", os.path.basename(img_path))
...
def xml2csv(xml_path):
    print("xml2csv invalid ,no panda")
    '''
